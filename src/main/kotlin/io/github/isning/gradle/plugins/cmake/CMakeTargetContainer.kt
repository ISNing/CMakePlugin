...
interface CMakeTargetFactory<T : CMakeTarget> : Named {
...
interface CMakeTargetContainerWithFactories : CMakeTargetContainer {
    val factories: NamedDomainObjectCollection<CMakeTargetFactory<*>>
}

internal inline fun <reified T : CMakeTarget> CMakeTargetContainerWithFactories.configureOrCreate(
    targetName: String,
